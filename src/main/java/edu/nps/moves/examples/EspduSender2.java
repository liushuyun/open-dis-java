 ...
 * @author DMcG
 */
public class EspduSender2 implements Runnable{
...
//        -81.588704,29.972218
//        -80.1895,25.7838
        double lat = 30.004595;
        double lon = -82.095534;
...
//            psi = psi + idx;
//            orientation.setPsi(psi);
//            orientation.setTheta((float)(orientation.getTheta() + idx /4.3));
            //            "entityOrientation": {
//                "psi": 0.22426133,
//                        "theta": -0.13140167,
//                        "phi": -2.1063502
//            },
            orientation.setPsi(0.22426133f);
            orientation.setTheta(-0.13140167f);
            orientation.setPhi(-2.1063502f);
...
//            velocity.setX(216.0441f * 10);
            velocity.setX(2160.0441f);
            velocity.setY(49.279255f);
            velocity.setZ(29.286453f);
            ...
            Thread.sleep(TimeUnit.SECONDS.toMillis(DIS_HEARTBEAT_SECS));//10s
        }
    }
